  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We will plan and strategize the project to make sure we are on the same page.">
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description="We will develop the project and keep you updated with the progress.">
        ...
        <Card title="Development & launch launch" icon={<AceternityIcon order="Phase 3"/>}
        description="We will develop the project and launch it We will develop the project and launch it.">
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-[50%] bottom-[50%] left-[50%} translate-x-[-50] translate-y-[-50%] group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
